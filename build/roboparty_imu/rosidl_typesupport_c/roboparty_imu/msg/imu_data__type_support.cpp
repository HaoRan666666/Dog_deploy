...
static const _IMUData_type_support_symbol_names_t _IMUData_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, roboparty_imu, msg, IMUData)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, roboparty_imu, msg, IMUData)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, roboparty_imu, msg, IMUData)() {
  return &::roboparty_imu::msg::rosidl_typesupport_c::IMUData_message_type_support_handle;
}
