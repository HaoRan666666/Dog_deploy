...
#include "roboparty_imu/msg/detail/imu_data__rosidl_typesupport_fastrtps_c.h"
...
using _IMUData__ros_msg_type = roboparty_imu__msg__IMUData;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = roboparty_imu__msg__IMUData;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const roboparty_imu__msg__IMUData * ros_message = static_cast<const roboparty_imu__msg__IMUData *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_roboparty_imu__msg__IMUData(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  roboparty_imu__msg__IMUData * ros_message = static_cast<roboparty_imu__msg__IMUData *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_roboparty_imu__msg__IMUData(cdr, ros_message);
}

static uint32_t _IMUData__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_roboparty_imu__msg__IMUData(
...
static size_t _IMUData__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_roboparty_imu__msg__IMUData(
