...
: ${AMENT_CURRENT_PREFIX:="/home/rp/Dog_deploy/install/roboparty_imu"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/roboparty_imu/environment/pythonpath.sh"
