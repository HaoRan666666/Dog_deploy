...
bool roboparty_imu__msg__imu_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("roboparty_imu.msg._imu_data.IMUData", full_classname_dest, 35) == 0);
  }
  roboparty_imu__msg__IMUData * ros_message = _ros_message;
  {  // device_id
...
PyObject * roboparty_imu__msg__imu_data__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("roboparty_imu.msg._imu_data");
